...
library(shiny)
library(DT)
library(shinythemes) # Para usar temas de Bootstrap
```
...
# Interfaz de usuario
fluidPage(
  theme = shinytheme("cerulean"), # Aplicar un tema de Bootstrap
    ...
    tabPanel("Registro",
      fluidRow(
        column(6,
          ...
          actionButton("registrar", "Registrar", class = "btn btn-primary")
        ),
        column(6,
    ...
    tabPanel("Encuesta",
      fluidRow(
        column(12,
          ...
          actionButton("enviar_encuesta", "Enviar Encuesta", class = "btn btn-success")
        )
      )
    )
  )
